          ...
          <div className="parent">
            <div className="bottom-card">
              <div className="left-content">
                <h6>Get Early Access to Premium Features (PreSale)</h6>
                <p className="text-white">
                  You may purchase the premium features in the Bamboo Crypto app
                  ahead of the launch. These features will include - account
                  verification, premium DM/InMail, subscription button, Advanced
                  monetization, official account etc
                </p>
              </div>
